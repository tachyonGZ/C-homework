...
{
public:
	CCuboid(double length, double height, double width)
...
private:
	double m_length, m_height, m_width;
...
int main(int argc, char **argv)
{
	...
	{
		std::cout << std::setiosflags(std::ios::fixed) << std::setprecision(3) << ca[i].get_volume() << " ";
	}
	return 0;
}